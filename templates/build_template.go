...
setup_vendor() {
  ...
  timeout 30m "${BUILD_DIR}/vendor/android-prepare-vendor/execute-all.sh" --fuse-ext2 --keep --yes --device "${DEVICE}" --buildID "${AOSP_BUILD}" --output "${BUILD_DIR}/vendor/android-prepare-vendor"
